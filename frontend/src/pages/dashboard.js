...
const Dashboard = () => {
    ...
    useEffect(() => {
        const getUsers = async () => {
            const response = await fetch('http://localhost:5500/api/user/users')
    ...
    useEffect(() => {
        ...
        const approveSignUpReq = async () => {
            ...
            const response = await fetch(`http://localhost:5500/api/user/${upIdCh}`,{
                method: 'PATCH',
            ...
            const sendEmail = await fetch('http://localhost:5500/api/user/sendEmail', {
                method: 'POST',
    ...
    useEffect(() => {
        ...
        const deleteSignUpReq = async () => {
            const response = await fetch(`http://localhost:5500/api/user/${delIdCh}`, {
                method: 'DELETE'
            })
    ...
    useEffect(() => {
        ...
        const ApprovePdf = async () => {
            const response = await fetch(`http://localhost:5500/api/file/${upPdfCh}`,{
                method: 'PATCH',
    ...
    useEffect(() => {
        const deletePdf = async () => {
            const response = await fetch(`http://localhost:5500/api/file/${delPdfCh}`, {
                method: 'DELETE'
            })
